...
class MyTests(unittest.TestCase):
    ...
    def test_true(self):
        ...
        self.assertEqual(self.schema.color_output(), self.expected)
    ...
    def test_true_m(self):
        ...
        opts.mono = True
        self.schema.create_schema(self.data_in)
        self.assertEqual(self.schema.mono_output(), self.expected)
